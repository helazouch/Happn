...
import { ParticipationRepository } from "../../../DataLayer/repositories/ParticipationRepository.ts";
...
const EventItem: React.FC<EventItemProps> = ({
  ...
  useEffect(() => {
    const fetchParticipantsCount = async () => {
      if (eventId && id_version) {
        const count = await ParticipationRepository.getParticipantsCountExcludingCancelled(eventId, id_version);
        setCurrentParticipants(count);
      }
    };
    
    fetchParticipantsCount();
  }, [eventId, id_version]); // Effectué lors du changement d'eventId ou id_version
